            ...
            <>
                ...
                <div className={"viewGrid"}>
                    <div className={"column"}>
                        ...
                        <p>*photo avatar*</p>
                        <p className={"line"}>Sex: <text
                            className={"variable"}>{this.state.algorithm.sexe ? "Man" : "Woman"}</text></p>
                        <p className={"line"}>Age: <text className={"variable"}>{this.state.algorithm.age} years</text>
                        </p>
                        <p className={"line"}>Height: <text
                            className={"variable"}>{this.state.algorithm.taille} cm</text></p>
                        <p className={"line"}>Syst: <text className={"variable"}>{this.state.algorithm.syst} mmHg</text>
                        </p>
                        <p className={"line"}>Glyc: <text className={"variable"}>{this.state.algorithm.glyc} g/L</text>
                        </p>
                        <p className={"line"}>Chol: <text className={"variable"}>{this.state.algorithm.chol} g/L</text>
                        </p>
                        <p className={"line"}>HDL: <text className={"variable"}>{this.state.algorithm.hdl} g/L</text>
                        </p>
                        <p className={"line"}>Diabete: <text
                            className={"variable"}>{this.state.algorithm.diab ? "Yes" : "No"}</text></p>
                        <p className={"line"}>Infarctus: <text
                            className={"variable"}>{this.state.algorithm.inf ? "Already have" : "No"}</text></p>
                        <p className={"line"}>AVC: <text
                            className={"variable"}>{this.state.algorithm.avc ? "Already have" : "No"}</text></p>
                        <h2>Family</h2>
                        <p className={"line"}>Infarctus: <text
                            className={"variable"}>{this.state.algorithm.avc ? "Yes" : "No"}</text></p>
                        <p className={"line"}>Cancer: <text
                            className={"variable"}>{this.state.algorithm.avc ? "Yes" : "No"}</text></p>
                    ...
                    <div className={"column"}>
                        <h2>Your risks</h2>
                        <p>*photo avatar*</p>
                        <p className={"line"}>Stroke: <text id={"result"}
                                                            className={"variable"}>{Math.floor(this.state.algorithm.infRate)}%</text>
                        </p>
                        <ProgressBar bgcolor={"#25FDE9"} now={this.state.algorithm.infRate}/>

                        <p className={"line"}>Diabetes: <text id={"result"}
                                                              className={"variable"}>{Math.floor(this.state.algorithm.diaRate)}%</text>
                        </p>
                        <ProgressBar bgcolor={"#90EE90"} now={this.state.algorithm.diaRate}/>

                        <p className={"line"}>Cancer: <text id={"result"}
                                                            className={"variable"}>{Math.floor(this.state.algorithm.canRate)}%</text>
                        </p>
